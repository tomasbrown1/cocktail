<?php
$pageTitle = 'Gin Sour';
$pageDescription = 'How to make a Gin Sour';
...
?>
				...
				<ul>
					...
					<li>Add the gin, lemon juice, sugar syrup and bitters and shake vigorously</li> 
					<li>Strain into an Old Fashioned glass full of ice</li>
					<li>garnish with the lemon and cherry</li>
				</ul>
				<h2>History:</h2>
				<p>A cocktail from the ‘Sours’ category that predates prohibition in the US (1920-1933)</p>
				<h2>Variations:</h2>
				<p>
					...
					<a href="tomcollins.php">Tom Collins</a>
				</p>
